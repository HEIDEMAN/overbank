...
/*
 This useful implementation of the Levbenshtein distance algorithn
 follows the "Categories" paradigm of objective C.
 Essentially, a category allows you to add methods to an existing 
 class without subclassing it or needing to know any of the details 
